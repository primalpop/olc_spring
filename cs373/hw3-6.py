...
class robot:
    ...
    def sense(self, noise=0): #do not change the name of this function
        Z = []
        ...
        for i in range(len(landmarks)):
            ...
            before = atan2(dy, dx)% (2.0*pi) - self.orientation 
            if noise:
                Z.append(before + random.gauss(0.0, self.bearing_noise))
            else:
                Z.append(before)
